/* ============================================================
   Aria Dashboard — inline SVG icon helper.
   Lucide-style: 24x24 viewBox, 1.5px stroke, currentColor.
   Usage: icon('home') | icon('search', 16)
   NO emoji in chrome — these are the only pictograms allowed.
   ============================================================ */
'use strict';
...
const ICONS = {
  ...
  'instagram': '<rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37a4 4 0 1 1-7.91 1.26 4 4 0 0 1 7.91-1.26z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>',
  ...
  'handshake': '<path d="M11 17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-5l4-7h8"/><path d="m14 5 4 0 4 7v5a2 2 0 0 1-2 2h-1"/><path d="m7 12 4 4 6-6"/>',
  'flask': '<path d="M10 2v7L4.5 19a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 9V2"/><path d="M8.5 2h7"/><path d="M7 16h10"/>',
};

function icon(name, size) {
  const inner = ICONS[name] || ICONS['alert-circle'];
  const s = size || 18;
